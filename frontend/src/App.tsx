...
import { BOOKING_PATH, CONTACT_PATH, HARROGATE_PATH, HOME_PATH, KNARESBOROUGHCASTLE_PATH, LEEDS_PATH, LOGIN_PATH, SIGNUP_PATH, TAKEAWAY_PATH } from "./constants/paths";
